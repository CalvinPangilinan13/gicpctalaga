...
$config['base_url'] = rtrim($scheme.'://'.$host.$base_path, '/').'/';
...
|
*/
$config['encryption_key'] = 'gicp-talaga-2026-secure-key-change-before-production';
...
$config['sess_cookie_name'] = 'gicpctalaga_session';
