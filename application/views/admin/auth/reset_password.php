...
<head>
	...
	<title>Reset Password | GICP Talaga CMS</title>
...
<div class="auth-shell">
	<div class="auth-card">
		<h1 class="auth-title mb-3">Create New Password</h1>
		...
		<form method="post">
			...
			<button class="btn btn-admin w-100" type="submit">Save Password</button>
		</form>
	</div>
</div>
</body>
